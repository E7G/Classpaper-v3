g++ -O3 -std=c++17 -lstdc++ main.cpp -lole32 -I"include/" -L"lib/" -lwebui-2-static -lws2_32 -Wall -Wl,-subsystem=windows -luser32 -static -lws2_32 -o main.exe
g++ -O3 -std=c++17 -lstdc++ main.cpp -lole32 -I"include/" -L"lib/" "lib/webui-2.dll" -lws2_32 -Wall -Wl,-subsystem=windows -luser32 -lws2_32 -o main-dyn.exe
